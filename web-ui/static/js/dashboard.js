...
class Dashboard {
    constructor() {
        ...
        // Track if About event handlers are set up
        this.aboutEventHandlersSetup = false;
    ...
    async init() {
        ...
        // Set up About tab event handlers (for buttons that should work immediately)
    ...
    setupAboutEventHandlers() {
        ...
        if (this.aboutEventHandlersSetup) {
            return;
        }
        ...
        this.aboutEventHandlersSetup = true;
    }
